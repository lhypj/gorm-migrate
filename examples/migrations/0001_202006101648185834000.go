...
func (*Migrations) Migration_0001_202006101648185834000() *core.Operations {
	...
	return &core.Operations{Revision: "0001_202006101648185834000", DownRevision: []string{""}, Operations: ops}
}