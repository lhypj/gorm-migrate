...
func (*Migrations)Migration_0001_202005291945296424000() *core.Operations {
	...
	ops = append(ops,
		...
		&core.Operation{Action: core.DELETEUniqueIndex, TableName: "create_table_tests", IndexName: "idx_create_table_tests_deleted_at", IndexFieldNames: []string{"deleted_at"}},
	)
