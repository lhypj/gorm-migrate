...
func (*Migrations)Migration_0001_202006011414281206000() *core.Operations {
	...
	return &core.Operations{Revision: "0001_202006011414281206000", DownRevision: []string{""}, Operations: ops}
}